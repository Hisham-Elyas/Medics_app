import 'package:cuer_city/core/constant/string.dart';
...
List<CategoryModel> categoryHomeList = [
  CategoryModel(img: ImageAssetSVG.doctorLogo, name: 'Doctor'),
...
List<CategoryModel> categoryDoctorList = [
  ...
  CategoryModel(img: ImageAssetSVG.lungsIcon, name: 'Lungs Specialist'),
